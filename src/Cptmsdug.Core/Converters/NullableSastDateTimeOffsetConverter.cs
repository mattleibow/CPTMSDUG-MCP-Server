...
/// <summary>
/// Converts nullable DateTimeOffset to/from SAST format: "dd/MM/yyyy HH:mm" with UTC+2 offset
/// </summary>
public class NullableSastDateTimeOffsetConverter : JsonConverter<DateTimeOffset?>
{
    ...
    public override void Write(Utf8JsonWriter writer, DateTimeOffset? value, JsonSerializerOptions options)
    {
        if (value.HasValue)
        {
            ...
            var sastTime = value.Value.ToOffset(SastOffset);
